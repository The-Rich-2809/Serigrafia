...
-- Creación de la tabla Rol para dar roles a los usuarios
CREATE TABLE Rol(
...
-- Creación de la tabla Permisos para poder dar una mejor administracion al dueño
...
-- Cambiar la autorización de la base de datos
...
INSERT INTO Usuario(Usuario,Nombre,Correo,Contraseña,Id_Rol) VALUES
